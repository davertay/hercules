...
SPIKE = "/tmp/spike"
STDOUT_LOG = os.path.join(SPIKE, "stdout.log")
STDERR_LOG = os.path.join(SPIKE, "stderr.log")
...
cmd = [
    ...
    "--allowedTools", "Read", "Grep", "Glob", "mcp__spike__ask_user",
    "--mcp-config", os.path.join(SPIKE, "mcp.json"),
    "--append-system-prompt-file", os.path.join(SPIKE, "steer.md"),
    "--session-id", session_id,
] + extra

PROMPT = ("I need to add a caching layer to my app. Ask me exactly one "
